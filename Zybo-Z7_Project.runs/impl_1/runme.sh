...
HD_PWD='/home/ozorakobo/Zybo-Z7/Zybo-Z7_Project/Zybo-Z7_Project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ZyboZ7_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ZyboZ7_design_wrapper.tcl -notrace
