...
HD_PWD='/home/ozorakobo/Zybo-Z7/Zybo-Z7_Project/Zybo-Z7_Project.runs/ZyboZ7_design_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ZyboZ7_design_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ZyboZ7_design_xbar_0.tcl
